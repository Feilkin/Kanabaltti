function love.conf(t)
    t.identity = "kanabaltti"           -- The name of the save directory (string)
    ...
    t.window.title = "Kanabaltti"       -- The window title (string)
    t.window.icon = nil                 -- Filepath to an image to use as the window's icon (string)
    t.window.width = 1140               -- The window width (number)
